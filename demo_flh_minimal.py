"""
Read in 3d magnetic field datacube, and plot field line helicity of original field B and reference field Bp in minimal gauge. Also plot the relative field-line helicity (i.e. their difference) for this gauge.
...
plt.savefig('flhminimal.png', bbox_inches='tight')
plt.show()
